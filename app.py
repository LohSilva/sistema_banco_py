...
def sacar(*, valor, saldo, extrato, numero_saque_diario, limite_maximo_por_saque):
    if valor <= 0.00:
        imprimir_mensagem_erro("O valor do saque deve ser positivo.")
        return saldo, extrato
...
def cadastrar_conta_corrente(cliente):
    ...
    conta_corrente = {
        ...
        "conta_corrente": numero_conta_corrente,
        "cliente": cliente,
        "saldo": 0.00,
        "extrato": ""
    }
...
def main():
    ...
    while True:
        ...
        if opcao == 1:
            ...
            saldo, extrato = sacar(valor=valor_saque, saldo=saldo, extrato=extrato, numero_saque_diario=numero_saque_diario, limite_maximo_por_saque=limite_maximo_por_saque)
        elif opcao == 3:
